...
parcelHelpers.export(exports, "loadShoe", ()=>loadShoe
);
parcelHelpers.export(exports, "loadShoes", ()=>loadShoes
);
...
const loadShoes = async function(limit) {
    try {
        const res = await fetch(`${_configJs.API_URL_ALLSHOES}${limit}&brand=jordan`, {
            method: "GET",
            headers: {
...
const filterShoesByYear = async function(year, limit) {
    try {
        const res = await fetch(`${_configJs.API_URL_ALLSHOES}${limit}&releaseYear=${year}&brand=jordan`, {
            method: "GET",
            headers: {
                "x-rapidapi-host": "v1-sneakers.p.rapidapi.com",
                "x-rapidapi-key": "617301673dmsh04fb709ab7b7f74p1c2ff5jsnde2330604c58"
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","./config.js":"beA2m"}],"JacNc":[function(require,module,exports) {
...
parcelHelpers.export(exports, "API_URL_ALLSHOES", ()=>API_URL_ALLSHOES
);
const API_URL = "https://the-sneaker-database.p.rapidapi.com/sneakers/";
const API_URL_ALLSHOES = "https://v1-sneakers.p.rapidapi.com/v1/sneakers?limit=";

},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"kRNIF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class ShoesView {
